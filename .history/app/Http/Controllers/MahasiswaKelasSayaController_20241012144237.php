...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function generateFuzzy(Kelas $kelas, Materi $materi){
        try {
            ...
            if ($cekTugasKelompok->rata_rata > 2.1 && $cekTugasKelompok->rata_rata <=3) {
                $skor_kelompok = 3;
                $kategori_kelompok = "Kreasi";
            }elseif ($cekTugasKelompok->rata_rata >= 1.3 && $cekTugasKelompok->rata_rata <=2.1) {
                $skor_kelompok = 2;
                $kategori_kelompok = "Evaluasi";
            }elseif ($cekTugasKelompok->rata_rata >= 0 && $cekTugasKelompok->rata_rata <=1.29) {
                $skor_kelompok = 1;
