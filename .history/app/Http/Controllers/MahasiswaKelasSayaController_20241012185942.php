    ...
    public function generateFuzzy(Kelas $kelas, Materi $materi){
        try {
            ...
            $topikBaru = Materi::with(['topikPembahasanKelas'])
                        ...
                        ->first();
            $kelasMahasiswaId = KelasMahasiswa::where('kelas_id',$kelas->id)->where('mahasiswa_id',Auth::user()->id)->first();
            ...
            if (!$isCreated && !$isEnrolled) {
                ...
                KelasMahasiswaDetail::create([
                    'kelas_mahasiswa_id' => $isEnrolled ? $isEnrolled->id : null,
                    'kelas_id' => $kelas->id,
                ...
                ], 400); // Gunakan 400 Bad Request alih-alih 500 Internal Server Error
            }
        } catch (\Exception $e) {
