...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function utsKelas(Kelas $kelas){
        ...
        $tanggalUts = Carbon::parse($peserta->utsSesi->tanggal_dilaksanakan)->format('Y-m-d');

        // Parsing waktu mulai dan selesai dari format AM/PM ke Carbon
        $waktuMulai = Carbon::createFromFormat('H:i:s', $peserta->utsSesi->waktu_mulai)->format('H:i:s');
        $waktuSelesai = Carbon::createFromFormat('H:i:s', $peserta->utsSesi->waktu_selesai)->format('H:i:s');

        // Menghitung batas waktu masuk: 10 menit sebelum UTS dimulai
        $batasWaktuMasuk = Carbon::createFromFormat('H:i:s', $waktuMulai)->subMinutes(10)->format('H:i:s');

        // Menghitung batas waktu terakhir masuk: 2 menit setelah UTS dimulai
        $batasWaktuTerakhir = Carbon::createFromFormat('H:i:s', $waktuMulai)->addMinutes(2)->format('H:i:s');
