...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function utsKelas(Kelas $kelas){
        ...
        $waktuMulai = Carbon::createFromFormat('h:i A', $peserta->utsSesi->waktu_mulai)->format('h:i A');
$waktuSelesai = Carbon::createFromFormat('h:i A', $peserta->utsSesi->waktu_selesai)->format('h:i A');
