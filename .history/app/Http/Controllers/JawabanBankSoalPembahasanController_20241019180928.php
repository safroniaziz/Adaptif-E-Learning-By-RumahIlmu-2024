...
class JawabanBankSoalPembahasanController extends Controller
{
    public function index(){
        $kelas = BankSoalPembahasan::with(['jawabanKuisMateris'])->orderBy('created_at','desc')->get();
    ...
    public function detail(Kelas $kelas){
        $soalKuis = BankSoalPembahasan::with(['kelas'])->where('kelas_id',$kelas->id)->orderBy('created_at','desc')->get();
