    ...
    public function simpanPenilaian(Request $request, Kelas $kelas, Materi $materi, TugasKelompokMateri $tugasKelompok)
    {
        try {
            ...
            $penilaianKelompok = PenilaianKelompok::create([
                'topik_pembahasan_kelas_id'  => $topic->topicId, // Sesuaikan dengan nama yang ada di migration
                'penilai_id'                 => Auth::user()->id, // Penilai adalah user yang sedang login
                'mahasiswa_id'               => $request->userId, // Id mahasiswa yang dinilai
                'pengalaman'                 => $request->work_experience, // Sesuaikan dengan nama field di migration
