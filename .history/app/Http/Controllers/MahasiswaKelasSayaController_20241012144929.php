    ...
    public function generateFuzzy(Kelas $kelas, Materi $materi){
        try {
            ...
            if ($cekNilaiKomentar == 0) {
                $skor_diskusi = 1;
                $kategori_diskusi = "Resolusi";
            }else {
                if ($cekNilaiKomentar/$cekJumlahKomentar->count() >= 3.1 && $cekNilaiKomentar/$cekJumlahKomentar->count() <=4) {
                    $skor_diskusi = 4;
                    $kategori_diskusi = "Resolusi";
                }elseif ($cekNilaiKomentar/$cekJumlahKomentar->count() >= 2.1 && $cekNilaiKomentar/$cekJumlahKomentar->count() <=3.09) {
                    $skor_diskusi = 3;
                    $kategori_diskusi = "Eksplorasi";
                }elseif ($cekNilaiKomentar/$cekJumlahKomentar->count() >= 1.1 && $cekNilaiKomentar/$cekJumlahKomentar->count() <=2.09) {
                    $skor_diskusi = 3;
                    $kategori_diskusi = "Integrasi";
                }elseif ($cekNilaiKomentar/$cekJumlahKomentar->count() >= 0 && $cekNilaiKomentar/$cekJumlahKomentar->count() <=1.09) {
                    $skor_diskusi = 1;
                    $kategori_diskusi = "Resolusi";
                }
            }
