...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function generateFuzzy(Kelas $kelas, Materi $materi){
        try {
            ...
            if ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1111;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1212;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 1333;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2111;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2222;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 2333;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 3111;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3222;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3313;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1211;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1323;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1133;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1221;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 1322;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 1123;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1321;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 1232;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1233;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 1331;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 1331;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1222;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1131;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 1332;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1223;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 2113;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2223;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2133;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2132;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 2323;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 2122;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 2233;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3131;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 2112;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2312;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2313;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2123;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2311;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 2231;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 2331;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2121;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3233;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 2212;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3132;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3231;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 3;
                $kode_aturan = 3331;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2131;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 3213;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 3232;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3321;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 3121;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 3113;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 3322;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3323;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3221;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 3211;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3212;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3311;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3223;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3312;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3133;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 2321;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 1213;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 3123;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1132;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1121;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1311;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2213;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 3112;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2221;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1112;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3122;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3333;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 2332;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2322;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1313;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1231;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1312;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2232;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 1113;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2211;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1122;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 3332;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 1;
                $kode_aturan = 1114;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 1234;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1224;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 1334;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 2114;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 3114;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2134;
            }elseif ($skorPostTest == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 2124;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2224;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2324;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3324;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3134;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3224;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3334;
            }elseif ($skorPostTest == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3124;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3234;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 1324;
            }elseif ($skorPostTest == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1314;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2314;
            }elseif ($skorPostTest == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2334;
            }elseif ($skorPostTest == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3314;
            }elseif ($skorPostTest == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3214;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1124;
            }elseif ($skorPostTest == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1134;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2234;
            }elseif ($skorPostTest == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2214;
            }elseif ($skorPostTest == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1214;
            }
