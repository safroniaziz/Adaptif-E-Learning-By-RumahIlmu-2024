...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function utsKelas(Kelas $kelas){
        ...
        if ($tanggalSekarang < $tanggalUts) {
            ...
            if ($tanggalSekarang->between($batasWaktuMasuk, $waktuSelesai)) {
                // Jika waktu sekarang ada di antara batas waktu masuk dan waktu selesai
                return view('mahasiswa/kelas_saya/ujian.uts', compact('kelas', 'peserta'));

            } elseif ($tanggalSekarang < $batasWaktuMasuk) {
