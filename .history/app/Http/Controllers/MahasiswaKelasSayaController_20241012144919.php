    ...
    public function generateFuzzy(Kelas $kelas, Materi $materi){
        try {
            ...
            if ($cekNilaiKomentar == 0) {
                ...
                if ($cekNilaiKomentar/$jumlah_komentar->count() >= 3.1 && $cekNilaiKomentar/$jumlah_komentar->count() <=4) {
                    $skor_diskusi = 4;
                    $kategori_diskusi = "Resolusi";
                }elseif ($cekNilaiKomentar/$jumlah_komentar->count() >= 2.1 && $cekNilaiKomentar/$jumlah_komentar->count() <=3.09) {
                    $skor_diskusi = 3;
                    $kategori_diskusi = "Eksplorasi";
                }elseif ($cekNilaiKomentar/$jumlah_komentar->count() >= 1.1 && $cekNilaiKomentar/$jumlah_komentar->count() <=2.09) {
                    $skor_diskusi = 3;
                    $kategori_diskusi = "Integrasi";
                }elseif ($cekNilaiKomentar/$jumlah_komentar->count() >= 0 && $cekNilaiKomentar/$jumlah_komentar->count() <=1.09) {
                    $skor_diskusi = 1;
                    $kategori_diskusi = "Resolusi";
                }
            }
