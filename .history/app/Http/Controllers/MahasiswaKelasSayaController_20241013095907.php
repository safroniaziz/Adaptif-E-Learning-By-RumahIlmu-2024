...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function utsKelas(Kelas $kelas){
        ...
        $waktuMulai = Carbon::createFromFormat('h:i A', $peserta->utsSesi->waktu_mulai)->format('H:i:s');
        $waktuSelesai = Carbon::createFromFormat('h:i A ', $peserta->utsSesi->waktu_selesai)->format('H:i:s');
        ...
        function buatPesan($tanggalUts, $waktuMulai, $waktuSelesai) {
            return 'UTS akan dilaksanakan pada tanggal ' . Carbon::parse($tanggalUts)->translatedFormat('l, d F Y') .
                   ' dari pukul ' . Carbon::parse($waktuMulai)->format('h:i A') . ' sampai ' . Carbon::parse($waktuSelesai)->format('h:i A') . '.';
        }
