        ...
        try {
            ...
            foreach ($soals as $index => $soal) {
                ...
                if (!$soal_id || !$jawaban_id) {
                    \Log::warning("Data tidak lengkap untuk soal index {$index}");
                    continue;
                }
                ...
                if (!$jawabanBenar) {
                    \Log::warning("Jawaban benar tidak ditemukan untuk soal_id: {$soal_id}");
                    continue;
                }
            ...
            if (empty($nilais)) {
                throw new \Exception("Tidak ada data nilai yang valid untuk disimpan.");
            }
