...
class MahasiswaKelasSayaController extends Controller
{
    ...
    public function generateFuzzy(Kelas $kelas, Materi $materi){
        try {
            ...
            if ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1111;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1212;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 1333;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2111;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2222;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 2333;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 3111;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3222;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3313;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1211;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1323;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1133;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1221;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 1322;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 1123;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1321;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 1232;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1233;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 1331;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 1331;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1222;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1131;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 1332;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1223;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 2113;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2223;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2133;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2132;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 2323;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 2122;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 2233;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3131;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 2112;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2312;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2313;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2123;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2311;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 2231;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 2331;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2121;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3233;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 2212;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3132;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3231;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 3;
                $kode_aturan = 3331;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2131;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 3213;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 3232;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3321;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 3121;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 3113;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 3322;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3323;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3221;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 3211;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3212;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 3311;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3223;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3312;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3133;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 2;
                $kode_aturan = 2321;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 1213;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 3123;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1132;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1121;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1311;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 2213;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 3112;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2221;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1112;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 3122;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 3) {
                $bk = 3;
                $kode_aturan = 3333;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 2332;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2322;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 2;
                $kode_aturan = 1313;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 1231;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1312;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 2;
                $kode_aturan = 2232;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 3) {
                $bk = 1;
                $kode_aturan = 1113;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 1) {
                $bk = 1;
                $kode_aturan = 2211;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 2) {
                $bk = 1;
                $kode_aturan = 1122;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 2) {
                $bk = 3;
                $kode_aturan = 3332;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 1;
                $kode_aturan = 1114;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 1234;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1224;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 1334;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 2114;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 3114;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2134;
            }elseif ($skor_post == 2 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 2124;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2224;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2324;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3324;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3134;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3224;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3334;
            }elseif ($skor_post == 3 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3124;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3234;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 1324;
            }elseif ($skor_post == 1 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1314;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2314;
            }elseif ($skor_post == 2 && $skor_individu == 3 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2334;
            }elseif ($skor_post == 3 && $skor_individu == 3 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3314;
            }elseif ($skor_post == 3 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 3214;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 2 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1124;
            }elseif ($skor_post == 1 && $skor_individu == 1 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_aturan = 1134;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 3 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2234;
            }elseif ($skor_post == 2 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 3;
                $kode_aturan = 2214;
            }elseif ($skor_post == 1 && $skor_individu == 2 && $skor_kelompok == 1 && $skor_diskusi == 4) {
                $bk = 2;
                $kode_atu
            }
