...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('riwayat_fuzzies', function (Blueprint $table) {
            ...
            $table->integer('skor_posttest'); // Alias score_post_test
            $table->integer('skor_tugas_individu'); // Alias score_individu
            $table->integer('skor_tugas_kelompok'); // Alias score_kelompok
            $table->integer('skor_diskusi'); // Alias score_diskusi
            $table->integer('skor_berfikir_kritis'); // Alias berfikir_kritis
