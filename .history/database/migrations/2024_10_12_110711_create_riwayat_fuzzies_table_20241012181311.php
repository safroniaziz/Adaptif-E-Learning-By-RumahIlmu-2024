...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('riwayat_fuzzies', function (Blueprint $table) {
            ...
            $table->integer('skor_posttest')->nullable(); // Alias score_post_test
            $table->integer('skor_tugas_individu')->nullable(); // Alias score_individu
            $table->integer('skor_tugas_kelompok')->nullable(); // Alias score_kelompok
            $table->integer('skor_diskusi')->nullable(); // Alias score_diskusi
            $table->integer('skor_berfikir_kritis')->nullable(); // Alias berfikir_kritis
