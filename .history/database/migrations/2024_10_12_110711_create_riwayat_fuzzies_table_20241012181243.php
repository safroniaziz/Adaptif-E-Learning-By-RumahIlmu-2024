...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('riwayat_fuzzies', function (Blueprint $table) {
            ...
            $table->integer('skor_posttest', 5, 2)->default(0); // Alias score_post_test
            $table->integer('skor_tugas_individu', 5, 2)->default(0); // Alias score_individu
            $table->integer('skor_tugas_kelompok', 5, 2)->default(0); // Alias score_kelompok
            $table->integer('skor_diskusi', 5, 2)->default(0); // Alias score_diskusi
            $table->integer('skor_berfikir_kritis', 5, 2)->default(0); // Alias berfikir_kritis
