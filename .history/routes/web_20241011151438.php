...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/forum_diskusi/{diskusi}/update', [MahasiswaKelasSayaController::class, 'forumDiskusiupdate'])->name('mahasiswa.kelas_saya.diskusi.update');
    });
});
