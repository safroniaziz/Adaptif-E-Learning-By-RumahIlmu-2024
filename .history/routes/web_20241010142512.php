...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::get('/kelas_saya/{kelas}/detail_materi/{materi}/materi_pengayaan', [MahasiswaKelasSayaController::class, 'forumDiskusi'])->name('mahasiswa.kelas_saya.materi_pengayaan');
    });
});
