...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/generate_fuzzy', [MahasiswaKelasSayaController::class, 'simpanKuisPosttest'])->name('mahasiswa.kelas_saya.generate_fuzzy');
    });
});
