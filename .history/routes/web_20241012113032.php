...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/simpan_kuis_posttest', [MahasiswaKelasSayaController::class, 'simpanKuis'])->name('mahasiswa.kelas_saya.simpan_kuis_posttest');
    });
});
