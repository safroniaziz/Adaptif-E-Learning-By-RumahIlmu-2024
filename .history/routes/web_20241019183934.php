...
Route::middleware('auth','isDosen')->group(function(){
    ...
    Route::group(['prefix'  => 'kelas'],function(){
        Route::get('/soal_kuis',[BankSoalPembahasanController::class, 'index'])->name('soalKuis');
        Route::get('/{kelas}/soal_kuis/detail',[BankSoalPembahasanController::class, 'detail'])->name('soalKuis.detail');
