...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/tugas/{tugasKelompok}/anggota/penilaian', [MahasiswaKelasSayaController::class, 'simpanAnggota'])->name('mahasiswa.kelas_saya.simpan_anggota');
