...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::get('/mahasiswa/catatan_aktivitas', [MahasiswaProfilController::class, 'logAktivitas'])->name('mahasiswa.dashboard.logs');
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/forum_diskusi/update/{respon}', [MahasiswaKelasSayaController::class, 'forumDiskusiUpdate'])->name('mahasiswa.kelas_saya.diskusi.update');

        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/forum_diskusi/update', [MahasiswaKelasSayaController::class, 'forumDiskusiUpdate'])->name('mahasiswa.kelas_saya.diskusi.update');
    });
});
