...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::post('/kelas_saya/{kelas}/detail_materi/{materi}/tugas/{tugasKelompok}/anggota/penilaian', [MahasiswaKelasSayaController::class, 'simpanPenilaian'])->name('mahasiswa.kelas_saya.simpa');
