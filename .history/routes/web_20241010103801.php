...
Route::middleware('auth','isMahasiswa')->group(function(){
    ...
    Route::group(['prefix'  => '/mahasiswa'],function(){
        ...
        Route::get('/kelas_saya/{kelas}/detail_materi/{materi}/tugas_individu', [MahasiswaKelasSayaController::class, 'materiPengayaan'])->name('mahasiswa.kelas_saya.tugas_individu');
    });
});
