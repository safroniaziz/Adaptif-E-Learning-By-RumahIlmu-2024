...
Route::middleware('auth','isDosen')->group(function(){
    ...
    Route::group(['prefix'  => 'soal_kuis'],function(){
        ...
        Route::group(['prefix'  => '/kelas/{kelas}/jawaban'],function(){
            Route::get('/{soalKuis}/',[JawabanBankSoalPembahasanController::class, 'index'])->name('soalKuis');
            ...
            Route::delete('/{soalKuis}/soalKuis/{jawaban}/delete',[JawabanBankSoalPembahasanController::class, 'delete'])->name('soalKuis.delete');
        });
    });
