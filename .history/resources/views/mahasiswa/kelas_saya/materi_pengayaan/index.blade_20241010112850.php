        ...
        <div class="card card-custom mb-5">
            ...
            <div class="card-header bg-gradient-primary text-white position-relative" style="border-radius: 15px 15px 0 0;">
                ...
                <div class="card-title ms-5 ps-5">
                    <h2 class="text-white">{{ $pengayaan->judul }}</h2> <!-- Pastikan teks tetap putih -->
                </div>
            </div>
            <!--end::Card header-->
...
<style>
    ...
    .card-header {
        padding: 20px;
        background: linear-gradient(90deg, #007bff 0%, #00c6ff 100%); /* Pastikan background gradient biru */
    ...
    .card-title h2 {
        ...
        font-size: 24px;
        margin: 0;
        color: white; /* Pastikan teks title tetap putih */
    }
