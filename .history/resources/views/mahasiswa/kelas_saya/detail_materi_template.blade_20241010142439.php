                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 me-lg-20">
                        ...
                        <div class="mb-15">
                            ...
                            <div class="menu menu-rounded menu-column menu-title-gray-700 menu-state-title-primary menu-active-bg-light-primary fw-semibold">
                                ...
                                <div class="menu-item mb-1">
                                    <!--begin::Link-->
                                    <a href="{{ route('mahasiswa.kelas_saya.diskusi',[$kelas->id, $materi->id]) }}" class="menu-link py-3 {{ Request::routeIs('mahasiswa.kelas_saya.tugas_kelompok') ? 'active' : '' }}"><i class="fas fa-comments me-2"></i> Diskusi</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Item-->
                            </div>
