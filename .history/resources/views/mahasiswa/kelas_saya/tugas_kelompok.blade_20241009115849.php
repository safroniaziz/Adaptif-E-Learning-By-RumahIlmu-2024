            ...
            <div class="mb-15">
                ...
                @php
                    ...
                    if ($sudahDitambahkan) {
                        ...
                        $penilaian = \App\Models\PenilaianKelompok::where('topik_pembahasan_kelas_id', $materi->topik_pembahasan_kelas_id)
                                                                ->pluck('mahasiswa_id') // Ambil mahasiswa_id yang sudah dinilai
                                                                ->toArray();
                    }
                @endphp
