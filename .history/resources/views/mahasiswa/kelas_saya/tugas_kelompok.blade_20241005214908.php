                ...
                @endphp
                    ...
                    @if ($isAnggota)
                        <div class="alert alert-dismissible bg-light-primary border-primary border-dashed d-flex flex-column p-5 mb-2">
                            ...
                            <div class="d-flex flex-column pe-0 pe-sm-10">
                                <h5 class="mb-1">Anda adalah anggota kelompok</h5>
                                <span>File tugas kelompok Anda telah dikumpulkan.</span>
                                @if($sudahDitambahkan->pengumpulanTugasKelompok->file_tugas)
                                    <span class="text-primary" style="font-size:11px; margin-top: 10px;">File Tugas: {{ $sudahDitambahkan->pengumpulanTugasKelompok->file_tugas }}</span>
                                @endif
                            </div>
                        </div>

                        <!-- Card untuk menampilkan anggota kelompok -->
                        <div class="col-lg-12">
                                ...
                                <div class="card-body d-flex flex-column p-9 pt-3 mb-9">
                                    @foreach ($anggotaKelompok as $anggota)
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            @if ($isKetua && $anggota->mahasiswa_id != auth()->id())
                                                <!-- Hanya ketua yang dapat menghapus anggota -->
                        ...
                        @if ($isKetua)
                            <!-- Tombol untuk menambah anggota (hanya untuk ketua) -->
                    ...
                    @elseif ($statusUpload)
                        <!-- Form upload tugas (jika belum ada pengumpulan dan status upload aktif) -->
