...
<div class="flex-lg-row-fluid" id="reload">
    ...
    @foreach ($materi->tugasIndividus as $tugas)
        <div class="mb-1">
            <!--begin::Content-->
            <div class="mb-15">
                <!--begin::Title-->
                ...
                @php
                    ...
                    $sudahDitambahkan = \App\Models\PengumpulanTugasKelompokDetail::join('pengumpulan_tugas_individus','pengumpulan_tugas_individus.id','pengumpulan_tugas_individu_details.pengumpulan_tugas_individu_id')
                                    ->join('tugas_individu_materis','tugas_individu_materis.id','pengumpulan_tugas_individus.tugas_individu_id')
                                    ...
                                    ->where('pengumpulan_tugas_individu_details.mahasiswa_id', auth()->user()->id)
                    ...
                    if ($sudahDitambahkan) {
                        $anggotaKelompok = \App\Models\PengumpulanTugasKelompokDetail::where('pengumpulan_tugas_individu_id', $sudahDitambahkan->pengumpulan_tugas_individu_id)
                            ->with('mahasiswa')
                            ->get();
                        $isAnggota = true;
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (dropzone) {
                ...
                const routeUploadTugasKelompok = `{{ route('mahasiswa.kelas_saya.upload_tugas_individu', ['kelas' => 'PLACEHOLDER_KELAS', 'materi' => 'PLACEHOLDER_MATERI', 'tugasKelompok' => 'PLACEHOLDER_TUGAS']) }}`.replace('PLACEHOLDER_KELAS', encodeURIComponent(kelasId))
