    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (dropzone) {
                ...
                const routeUploadTugasKelompok = `{{ route('mahasiswa.kelas_saya.upload_tugas_individu', ['kelas' => 'PLACEHOLDER_KELAS', 'materi' => 'PLACEHOLDER_MATERI', 'tugasIndividu' => 'PLACEHOLDER_TUGAS']) }}`.replace('PLACEHOLDER_KELAS', encodeURIComponent(kelasId))
