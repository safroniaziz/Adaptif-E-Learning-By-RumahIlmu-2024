        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            hapusButtons.forEach(button => {
                button.addEventListener('click', function (e) {
                    ...
                    const tugasId = this.getAttribute('data-tugas-id'); // Ambil ID tugas yang akan dihapus
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            // Cari form dengan data-tugas-id yang sesuai
                            document.querySelector(`#form-hapus-tugas-${tugasId}`).submit();
                        }
                    });
                });
            });
