                                            ...
                                            <div class="timeline-content ms-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-5 fw-semibold mb-2">
                                                        {!! $soals->bankSoalPembahasan->pertanyaan !!}
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="d-flex align-items-center me-2">
                                                                    ...
                                                                    <div class="fs-7">
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="1" required>&nbsp;&nbsp;1 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="2">&nbsp;&nbsp;2 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="3">&nbsp;&nbsp;3 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="4">&nbsp;&nbsp;4 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="5">&nbsp;&nbsp;5 <br>
                                                                        </label>
                                                                        <br>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="6">&nbsp;&nbsp;6 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="7">&nbsp;&nbsp;7 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="8">&nbsp;&nbsp;8 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="9">&nbsp;&nbsp;9 <br>
                                                                        </label>
                                                                        <label for="" class="radio-inline">
                                                                            <input type="radio" name="nilai{{ $item->pertanyaan->id }}" value="10">&nbsp;&nbsp;10 <br>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </label>
