                    ...
                    <div class="modal-body">
                        ...
                        <form id="formPenilaian">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="nilai" name="nilai" min="1" max="10" required>
                            </div>
                            <div class="mb-3">
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '[data-bs-target="#modalPenilaian"]', function () {
            ...
            var namaMahasiswa = $(this).closest('tr').find('a').text(); // Ambil nama mahasiswa dari elemen <a>
