...
<script>
    ...
    document.querySelectorAll('.btn-edit-respon').forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Cari form balasan yang sesuai dengan ID diskusi
            var formBalas = document.querySelector('#formBalas-' + responId);
            ...
            if (formBalas) {
                ...
                console.error('Form dengan ID ' + responId + ' tidak ditemukan');
            }
        });
    });
});
