...
@push('scripts')
    <script>
        ...
        document.getElementById('kt_forms_widget_1_form').onsubmit = function() {
            // Ambil konten editor sebagai HTML dan simpan di input hidden
            var content = quill.root.innerHTML;
            document.getElementById('editor_content').value = content;
        };

        document.getElementById('kt_forms_widget_1_form').onsubmit = function() {
    // Ambil konten editor sebagai teks saja (tanpa HTML)
    var content = quill.getText().trim();  // Hilangkan spasi kosong di awal/akhir teks
    document.getElementById('editor_content').value = content;
};
