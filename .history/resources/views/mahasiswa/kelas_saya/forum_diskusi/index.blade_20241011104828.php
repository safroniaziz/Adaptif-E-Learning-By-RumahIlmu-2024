            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-5 mb-xxl-8">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <!--end::Header-->
                        <!--begin::Form-->
                        <form id="" action="{{ route('mahasiswa.kelas_saya.diskusi.post',[$kelas->id,$materi->id]) }}" method="POST" class="ql-quil ql-quil-plain pb-3">
                            @csrf @method('POST')
                            <!--begin::Title Input-->
                            <input type="text" name="judul" class="title-input" placeholder="Masukkan judul diskusi" required>
                            <!--end::Title Input-->
                            <!--begin::Editor-->
