                ...
                <div class="card mb-5 mb-xxl-8">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <form id="kt_forms_widget_1_form" class="ql-quil ql-quil-plain pb-3">
                            ...
                            <!--begin::Toolbar-->
                            <form action="your_submit_route" method="POST" name="kt_forms_widget_1_form">
                                @csrf
                                <div id="kt_forms_widget_1_editor_toolbar" class="ql-toolbar d-flex flex-stack py-2">
                                    <div class="me-2">
                                        <span class="ql-formats ql-size ms-0">
                                            <!-- Dropdown atau input lain yang ingin disubmit -->
                                            <select class="ql-size w-75px" name="size"></select>
                                        </span>
                                        <span class="ql-formats">
                                            <!-- Button styling for text formatting -->
                                    ...
                                    <div class="me-n3">
                                        ...
                                        <textarea class="form-control form-control-solid border ps-5" rows="3" name="comment" placeholder="Tuliskan komentar di sini.."></textarea>
                                        <!-- Submit Button -->
                    ...
                    <div class="card-footer pt-0">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="position-relative w-100">
                                <!--begin::Input-->
                                <textarea class="form-control form-control-solid border ps-5" rows="1" name="search" data-kt-autosize="true" placeholder="comment"></textarea>
                                <!--end::Input-->
                                <!--begin::Actions-->
                                <button type="submit" class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0 position-absolute top-50 end-0 translate-middle-y me-8 d-flex align-items-center">
