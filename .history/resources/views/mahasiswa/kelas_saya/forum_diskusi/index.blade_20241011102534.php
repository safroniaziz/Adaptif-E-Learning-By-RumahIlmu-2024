...
@push('styles')
    <style>
       .custom-btn-submit {
        ...
        #kt_forms_widget_1_editor .ql-editor p:first-child::before {
            content: 'Judul';
            color: #999;
            font-style: italic;
        }

        #kt_forms_widget_1_editor .ql-editor p:nth-child(2)::before {
            content: 'Isi diskusi';
            color: #999;
            font-style: italic;
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var quill = new Quill('#kt_forms_widget_1_editor', {
                ...
                placeholder: 'Masukan judul dan isi diskusi di sini',
                theme: 'snow'
            });

            // Insert two paragraphs by default
