                ...
                <div class="card mb-5 mb-xxl-8">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <form id="kt_forms_widget_1_form" class="ql-quil ql-quil-plain pb-3">
                            ...
                            <!--begin::Toolbar-->
                            <div  class="ql-toolbar d-flex flex-stack py-2">
                                <div class="me-2">
                                ...
                                <div class="me-n3">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary d-flex align-items-center" style="background-color: #007bff; color: white;">
