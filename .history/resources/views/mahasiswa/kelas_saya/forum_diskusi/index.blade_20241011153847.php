...
<script>
    ...
    editResponModal.addEventListener('show.bs.modal', function (event) {
        ...
        console.log('Modal opened. Action URL:', actionUrl); // Logging
    });
    ...
    formEditRespon.addEventListener('submit', function(e) {
        ...
        console.log('Form submitted. Sending request to:', actionUrl); // Logging
        ...
        .then(data => {
            console.log('Response data:', data); // Logging
            if (data.success) {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
