    ...
    <style>
       .custom-btn-submit {
        ...
        #kt_forms_widget_1_editor_title {
            height: 50px;
            margin-bottom: 1rem;
            border-bottom: 2px solid #007bff; /* Border bawah berwarna biru */
    padding-bottom: 0.5rem; /* Memberi jarak ke bawah */
    font-size: 1.25rem; /* Ukuran font lebih besar */
    font-weight: bold;
    transition: border-color 0.3s ease; /* Transisi
        }

        #kt_forms_widget_1_editor .ql-editor p:first-child {
            font-size: 1.25rem;
            font-weight: bold;
...
#kt_forms_widget_1_editor_title:focus-within {
    border-bottom-color: #0056b3; /* Ganti warna border saat fokus */
}
    </style>
@endpush
