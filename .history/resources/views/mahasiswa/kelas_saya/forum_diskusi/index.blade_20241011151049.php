...
<script>
    ...
    document.querySelectorAll('.btn-edit-respon').forEach(button => {
        button.addEventListener('click', function() {
            var responId = this.getAttribute('data-id');
            var pesan = this.getAttribute('data-pesan');
            var diskusiId = this.closest('.card-footer').querySelector('.btn-submit-balas').getAttribute('data-diskusi-id');

            // Cari form balasan global
            var formBalas = document.getElementById('formBalas');

            if (formBalas) {
                // Ubah action form sesuai dengan diskusi yang sedang diedit
                formBalas.setAttribute('action', '/kelas_saya/' + diskusiId + '/balas/' + responId);

                // Masukkan pesan yang di-klik ke textarea input di form yang sesuai
                ...
                if (!inputId) {
                    // Jika input hidden untuk respon_id belum ada, buat baru
                ...
                // Fokuskan ke textarea atau scroll ke area form
                textarea.focus();
