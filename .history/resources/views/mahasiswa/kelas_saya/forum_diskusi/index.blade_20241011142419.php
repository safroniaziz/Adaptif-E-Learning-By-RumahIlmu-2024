...
@section('contentMateri')
    ...
    <div class="d-flex pt-6">
        ...
        <div class="d-flex flex-column flex-row-fluid">
            ...
            <!-- Tambahkan tombol edit jika canDelete true dan pesan null -->
            @if($respon->canDelete && is_null($respon->pesan))
                <button class="btn btn-warning btn-sm mt-2 btn-edit-respon" data-id="{{ $respon->id }}" data-pesan="{{ $respon->pesan }}">Edit</button>
            @endif
        </div>
    </div>
@endforeach
