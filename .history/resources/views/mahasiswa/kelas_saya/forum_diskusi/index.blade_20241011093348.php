                ...
                <div class="card card-flush mb-10">
                    ...
                    <div class="card-footer pt-0">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--end::Author-->
                            <!--begin::Input group-->
                            <form action="your_submit_route" method="POST">
                                @csrf
                                <div class="position-relative w-100">
                                    <!--begin::Input-->
                                    <textarea type="text" class="form-control form-control-solid border ps-5" rows="1" name="search" value="" data-kt-autosize="true" placeholder="Tuliskan komentar di sini.."></textarea>
                                    <!--end::Input-->
                                    <!--begin::Actions-->
                                    <div class="position-absolute top-0 end-0 translate-middle-x mt-1 me-n14">
                                        <!--begin::Btn-->
                                        <button type="button" class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0">
