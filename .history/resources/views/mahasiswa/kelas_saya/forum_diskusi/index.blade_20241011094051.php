                    ...
                    <div class="card-footer pt-0">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="position-relative w-100">
                                <!--begin::Input-->
                                <textarea class="form-control form-control-solid border ps-5" rows="1" name="search" data-kt-autosize="true" placeholder="Tuliskan komentar di sini.."></textarea>
                                <!--end::Input-->
                                <!--begin::Actions-->
                                <button type="submit" class="btn btn-icon btn-sm btn-color-gray-500 btn-active-color-primary w-25px p-0 position-absolute top-50 end-0 translate-middle-y me-3 d-flex align-items-center">
                                    <i class="ki-duotone ki-check fs-2 me-4">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                    Kirim
