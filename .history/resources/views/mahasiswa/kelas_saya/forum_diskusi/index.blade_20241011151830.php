            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formEditRespon" action="{{ route('mahasiswa.kelas_saya.diskusi.update',[$kelas->id, $materi->id]) }}" method="POST">
                            @csrf
                            @method('POST')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.btn-edit-respon').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Isi modal dengan respon_id dan pesan
                var modal = document.getElementById('editResponModal');
                modal.querySelector('#responId').value = responId;
                modal.querySelector('#pesan').value = pesan;

                // Ubah action form agar sesuai dengan respon yang diedit
                var formEdit = document.getElementById('formEditRespon');
                formEdit.setAttribute('action', '/kelas_saya/edit_respon/' + responId);
            });
        });
    });
