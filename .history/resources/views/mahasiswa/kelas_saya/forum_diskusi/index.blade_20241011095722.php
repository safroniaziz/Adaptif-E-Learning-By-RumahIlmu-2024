                ...
                <div class="card mb-5 mb-xxl-8">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <form id="kt_forms_widget_1_form" action="{{ route('mahasiswa.kelas_saya.diskusi.post',[$kelas->id,$materi->id]) }}" method="POST" class="ql-quil ql-quil-plain pb-3">
                            ...
                            <!-- Hidden input to store the content of the editor -->
...
<script>
    ...
    // Tangkap konten editor Quill dan masukkan ke input hidden sebelum submit
    document.getElementById('kt_forms_widget_1_form').onsubmit = function(e) {
        // Ambil konten editor sebagai HTML
        var content = quill.root.innerHTML;

        // Periksa apakah konten kosong
        if (quill.getText().trim().length === 0) {
            alert("Silakan isi komentar sebelum submit!");
            e.preventDefault();
            return;
        }

        // Masukkan konten editor ke dalam input hidden
