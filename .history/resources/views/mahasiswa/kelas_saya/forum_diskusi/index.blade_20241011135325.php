            ...
            @foreach ($diskusis as $diskusi)
                <div class="card card-flush mb-10">
                    ...
                    <div class="card-footer pt-0">
                        ...
                        <!--end::Info-->
                        <!--begin::Comment form-->
                        <form action="{{ route('mahasiswa.kelas_saya.diskusi.balas',[$kelas->id, $materi->id, $diskusi->id]) }}" method="POST">
                            @csrf @method('POST')
                            <div class="d-flex align-items-center">
                                <!--begin::Author-->
                                ...
                                <div class="position-relative w-100">
                                    <!--begin::Input-->
                                    <textarea class="form-control form-control-solid border ps-5" rows="1" name="search" data-kt-autosize="true" placeholder="...."></textarea>
                                    <!--end::Input-->
                                    <!--begin::Actions-->
