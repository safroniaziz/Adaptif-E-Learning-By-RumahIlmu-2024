                    ...
                    <div class="card-body pb-0">
                        ...
                        <form id="kt_forms_widget_1_form" class="ql-quil ql-quil-plain pb-3">
                            ...
                            <div id="kt_forms_widget_1_editor_toolbar" class="ql-toolbar d-flex flex-stack py-2">
                                ...
                                <div class="me-n3">
                                    <!-- Submit Button with clear color -->
                                    <button type="submit" class="btn btn-icon btn-sm btn-primary" style="background-color: #007bff; color: white;">
                                        <i class="ki-duotone ki-check fs-2"></i>&nbsp; Kirim
                                    </button>
                                </div>
                            </div>
                            <!--end::Toolbar-->
