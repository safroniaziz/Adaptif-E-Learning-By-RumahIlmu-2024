...
<script>
    ...
    function updateCountdown() {
        ...
        if (timeLeft <= 0) {
            ...
            // Tampilkan Swal yang tidak bisa ditutup
            Swal.fire({
...
// ... (kode konversi waktu yang sudah ada) ...

// Modifikasi event listener untuk form submit
document.getElementById('kuisionerForm').addEventListener('submit', function(event) {
    ...
    if (timeLeft <= 0) {
        // Jika waktu sudah habis, langsung kirim form
        submitForm();
    } else {
        // Jika masih ada waktu, tampilkan konfirmasi seperti sebelumnya
        Swal.fire({
            title: 'Apakah Anda yakin?',
            text: "Anda tidak akan bisa mengubah jawaban setelah ini!",
            icon: 'warning',
