...
function startCountdown(endTime) {
    ...
    const countdownContainer = document.getElementById('countdown'); // Elemen alert yang sudah ada
    ...
    function updateCountdown() {
        ...
        // Jika ujian sudah dimulai tetapi belum selesai
            ...
            countdownElement.innerHTML = `Ujian berlangsung: ${hours}j ${minutes}m ${seconds}d`;
