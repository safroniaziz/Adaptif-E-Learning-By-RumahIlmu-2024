...
function showTimeUpAlert() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Temukan tombol "Simpan Jawaban" dan klik secara programatik
            const submitButton = document.querySelector('button[type="submit"]');
            if (submitButton) {
                submitButton.click();
            } else {
                console.error('Tombol submit tidak ditemukan');
                Swal.fire('Error!', 'Terjadi kesalahan saat menyimpan jawaban', 'error');
            }
        }
    });
}
...
document.getElementById('kuisionerForm').addEventListener('submit', function(event) {
    ...
    if (isTimeUp) {
        ...
        // Jika belum habis waktu, tanyakan konfirmasi dulu
        Swal.fire({
