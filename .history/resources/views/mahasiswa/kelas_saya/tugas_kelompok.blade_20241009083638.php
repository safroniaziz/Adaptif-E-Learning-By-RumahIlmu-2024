...
<div class="flex-lg-row-fluid" id="reload">
    ...
    @foreach ($materi->tugasKelompoks as $tugas)
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @foreach ($anggotaKelompok as $anggota)
                                            <tr>
                                                <td>
                                                    <a class="fs-7 fw-reguler text-gray-900 text-hover-primary">{{ $anggota->mahasiswa->id }}</a>
                                                </td>
        ...
        <div class="modal fade" id="modalPenilaian" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg"> <!-- Ubah ukuran modal menjadi lebih lebar -->
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <!-- Konten form penilaian -->
                        <form id="formPenilaian">
                            <!-- Form inputs di sini -->
                            <input type="text" id="tugasId" name="tugas_id"> <!-- Gunakan input type text -->
                            <input type="text" id="mahasiswaId" name="mahasiswa_id"> <!-- Gunakan input type hidden -->
                            <div class="mb-3">
