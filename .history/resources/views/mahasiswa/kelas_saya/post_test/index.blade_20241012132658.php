    ...
    <div class="mb-17">
        ...
        <form action="{{ route('mahasiswa.kelas_saya.simpan_kuis_posttest', [$materi->topikPembahasanKelas->kelas->id, $materi->id]) }}" method="POST">
            ...
            <div class="card-footer" style="text-align: left;padding: 15px;">
                <form action="{{ route('mahasiswa.kelas_saya.generate_fuzzy', [$materi->topikPembahasanKelas->kelas->id, $materi->id]) }}" method="POST">
                    button
                </form>
                <a href="{{ route('mahasiswa.kelas_saya.generate_fuzzy', [$materi->topikPembahasanKelas->kelas->id, $materi->id]) }}">Generate Fuzzy</a>
...
@push('scripts')
<script>
    // document.getElementById('generateFuzzyButton').addEventListener('click', function() {
    //     Swal.fire({
    ...
    //             // Mengirim POST request menggunakan fetch
    ...
    //                     // Jika berhasil, lakukan redirect ke halaman detail kelas
    //                     Swal.fire({
    //                         title: 'Berhasil!',
    //                         text: data.message,
    //                         icon: 'success',
    ...
    //                     });
    //                 } else {
    //                     // Jika gagal, tampilkan pesan error dengan SweetAlert
    //                     Swal.fire({
    //                         title: 'Gagal!',
    //                         text: data.message,
    //                         icon: 'error',
    ...
    //             })
    //             .catch(error => {
    //                 // Jika terjadi error dalam request (misal, masalah jaringan), tampilkan error dengan SweetAlert
    //                 Swal.fire({
