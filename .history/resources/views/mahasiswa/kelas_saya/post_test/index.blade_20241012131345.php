...
<script>
    document.getElementById('generateFuzzyButton').addEventListener('click', function() {
        Swal.fire({
            ...
            text: "Generate fuzzy untuk menentukan level materi anda pada topik berikutnya",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                // Arahkan ke route generateFuzzy di controller
                window.location.href = "{{ route('mahasiswa.kelas_saya.generate_fuzzy', [$materi->topikPembahasanKelas->kelas->id, $materi->id]) }}";
            }
        });
    });
