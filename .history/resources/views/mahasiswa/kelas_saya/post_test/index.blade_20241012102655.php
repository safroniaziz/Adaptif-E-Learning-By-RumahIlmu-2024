        ...
        @else
            @if ($alertTugasKelompok)
                <div class="alert alert-dismissible bg-light-danger border border-danger border-dashed d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        <h5 class="mb-1">Tidak Ada Tugas Kelompok</h5>
                        <span>Anda belum mengumpulkan tugas kelompok. Harap mengumpulkan tugas kelompok terlebih dahulu untuk melanjutkan.</span>
                    </div>
                    <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" >
                        <i class="ki-duotone ki-cross fs-1 text-danger">
                            <span class="path1"></span><span class="path2"></span>
            ...
            @else
                <div class="alert alert-dismissible bg-light-danger border border-danger border-dashed d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        <h5 class="mb-1">Tidak Ada Tugas Individu</h5>
                        <span>Anda belum mengumpulkan tugas individu. Harap mengumpulkan tugas individu terlebih dahulu untuk melanjutkan.</span>
                    </div>
                    <button type="button" class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto" >
                        <i class="ki-duotone ki-cross fs-1 text-danger">
                            <span class="path1"></span><span class="path2"></span>
