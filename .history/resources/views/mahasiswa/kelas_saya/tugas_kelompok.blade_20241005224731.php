...
@push('scripts')
    <script>
        document.getElementById('btn-hapus-tugas').addEventListener('click', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Submit the form via AJAX to handle success and error messages more effectively
                    let form = document.getElementById('form-hapus-tugas');
