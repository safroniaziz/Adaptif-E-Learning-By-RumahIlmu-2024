                            ...
                            <div class="card pt-4 mb-1 mb-xl-4">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-toolbar">
                                        <a href="{{ route('mahasiswa.kelas.ambil_kelas',[$kelas->id]) }}" class="btn btn-sm btn-flex btn-light-primary me-2">
                                            <i class="ki-duotone ki-pencil fs-3">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>Ambil Kelas
                                        </a>
                                        <a href="#" class="btn btn-sm btn-flex btn-light-primary me-2">
                                            <i class="ki-duotone ki-book fs-3">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>UTS
                                        </a>
                                        <a href="#" class="btn btn-sm btn-flex btn-light-warning">
                                            <i class="ki-duotone ki-book fs-3">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>UAS
