            ...
            <div class="mb-15">
                ...
                @php
                    ...
                    if ($sudahDitambahkan) {
                        ...
                        $fileUploaded = $sudahDitambahkan->pengumpulanTugasKelompok->file_tugas !== null;
                    }
                @endphp
                ...
                @elseif ($isAnggota)
                    ...
                    @if ($isKetua && $statusUpload )
                        ...
                        <div class="mt-5">
                            ...
                            @if($fileUploaded)
                                <button type="button" class="btn btn-danger btn-sm" id="hapus_file_tugas">
                                    Hapus File Tugas
                                </button>
                            @endif
                    ...
                    @elseif (!$isKetua && !$fileUploaded && $statusUpload && $currentTime <= $deadlineTime)
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_upload_tugas">
