                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 me-lg-20">
                        ...
                        <div class="mb-15">
                            ...
                            <div class="menu menu-rounded menu-column menu-title-gray-700 menu-state-title-primary menu-active-bg-light-primary fw-semibold">
                                ...
                                <div class="menu-item mb-1">
                                    <!--begin::Link-->
                                    <a href="https://www.jdoodle.com/online-java-compiler" target="_blank" class="menu-link py-3 {{ Request::routeIs('mahasiswa.kelas_saya.tugas_kelompok') ? 'active' : '' }}"><i class="fas fa-pencil-alt me-2"></i> Latihan</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Item-->
                                <div class="menu-item mb-1">
