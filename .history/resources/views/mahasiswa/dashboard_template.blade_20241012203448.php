                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="80">{{ $jumlahDiskusi }}</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="60" data-kt-countup-prefix="%">{{ $jumlahRespon }}</div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
