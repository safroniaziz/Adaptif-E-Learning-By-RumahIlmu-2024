    ...
    <div class="card">
        ...
        <div class="card-header card-header-stretch">
            ...
            <div class="card-title d-flex align-items-center">
                ...
                <div>
                    <h3 class="fw-bold m-0 text-gray-800">Catatan Aktivitas</h3>
                    <small class="text-muted">Menampilkan 15 aktivitas terbaru</small>
                </div>
            </div>
            <!--end::Title-->
        </div>
                    ...
                    <div class="timeline timeline-border-dashed">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-icon me-4">
                                <i class="fas fa-check fs-2 text-primary"></i>
                            </div>
                            <!--end::Timeline icon-->
                            ...
                            <div class="timeline-content mb-10 mt-n2">
                                ...
                                <div class="overflow-auto pe-3">
                                    <!--begin::Title-->
                                    <div class="fs-5 fw-semibold mb-2">{{ $aktivitas->description }}</div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        <!--begin::Info-->
                                        <div class="text-muted me-2 fs-7">{{ \Carbon\Carbon::parse($aktivitas->created_at)->locale('id')->translatedFormat('l, d F Y') }}</div>
                                        <!--end::Info-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                                            <img src="{{ asset(Auth::user()->foto ? 'storage/' . Auth::user()->foto : 'storage/fotos/profil.jpg') }}" alt="foto profil" />
