...
<!-- resources/views/mahasiswa/dashboard/pengaturan_profil.blade.php -->
<form id="kt_account_profile_details_form" action="{{ route('mahasiswa.dashboard.pengaturan_profil.update') }}" class="form" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="card-footer d-flex justify-content-end py-6 px-9">
        <button type="button" class="btn btn-primary" id="kt_account_profile_details_submit">Save Changes</button>
    </div>
</form>
