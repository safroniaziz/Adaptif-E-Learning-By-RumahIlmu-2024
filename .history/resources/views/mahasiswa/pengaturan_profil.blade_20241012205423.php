        ...
        if (result.isConfirmed) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.querySelector('[role="progressbar"]').style.width = data.completionPercentage + '%';
                    document.querySelector('[role="progressbar"]').setAttribute('aria-valuenow', data.completionPercentage);
                } else {
                    let errorMessage = '';
