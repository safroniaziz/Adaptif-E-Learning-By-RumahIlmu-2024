                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form actio n="{{ route('mahasiswa.kelas.ambil_kelas_post',[$kelas->id]) }}" method="POST">
                                        @csrf @method('POST')
                                        <!--begin::Tab Content-->
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire(
                            ...
                            location.reload(); // Reload halaman setelah swal berhasil
                        });
                    } else {
                        Swal.fire(
                            'Gagal!',
                    ...
                    Swal.fire(
                        'Gagal!',
                        'Terdapat kesalahan, silahkan cek kembali.',
                        'error'
                    );
                });
            }
