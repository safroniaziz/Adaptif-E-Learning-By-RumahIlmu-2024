                            ...
                            <tbody>
                                @foreach ($data->mahasiswas as $index => $mahasiswa)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-primary btn-sm btn-flat">{{ $mahasiswa->activities_count }} Data</a>
                                        </td>
                                        <td>
                                            <a href="" class="btn btn-primary btn-sm btn-flat">{{ $mahasiswa->activities_count }} Data</a>
                                        </td>
                                        <td>
                                            <a href="" class="btn btn-primary btn-sm btn-flat">{{ $mahasiswa->details_count }} Data</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
