...
<base href="../" />
		...
		<link href="{{ asset('assets/frontend/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
		<link href="{{ asset('assets/frontend/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
						...
						<div class="app-container container-xxl d-flex align-items-stretch justify-content-between" id="kt_app_header_primary_container">
							...
							<div class="d-flex flex-stack align-items-stretch flex-grow-1 flex-lg-grow-0">
								...
								<div class="d-flex align-items-center me-7">
									...
									<!--begin::Logo-->
									<a href="{{ route('mahasiswa.dashboard') }}" class="d-flex align-items-center logo-background">
										<img alt="Logo" src="{{ asset('assets/img/logo.png') }}" class="h-30px h-lg-55px" />
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Logo wrapper-->
								...
								<div class="app-navbar-item" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
											<a href="{{ route('mahasiswa.dashboard') }}" class="menu-link px-5">My Dashboard</a>
										</div>
										<!--end::Menu item-->
										...
										<div class="d-flex flex-column align-items-start me-3 gap-2">
											...
											<ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
												...
												<li class="breadcrumb-item text-gray-600">
													<a href="{{ route('mahasiswa.dashboard') }}" class="text-gray-600 text-hover-primary">Home</a>
												</li>
												<!--end::Item-->
												<!--begin::Item-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-body pt-9 pb-0">
                                                    ...
                                                    <div class="d-flex flex-wrap flex-stack">
                                                        ...
                                                        <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                                                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                                                ...
                                                                <span class="fw-bold fs-6" id="completion-percentage">{{ $completionPercentage }}%</span>
                                                            </div>
                                                            <div class="h-5px mx-3 w-100 bg-light mb-3">
                                                                <div class="bg-success rounded h-5px" role="progressbar" style="width: {{ $completionPercentage }}%;" aria-valuenow="{{ $completionPercentage }}" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                        </div>
                                                        <!--end::Progress-->
                                                    </div>
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                <!--begin::Nav item-->
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('account.aktivitas') ? 'active' : '' }}"
                                                       href="{{ route('mahasiswa.dashboard.aktivitas') }}">Catatan Aktivitas</a>
                                                </li>
                                                <!--end::Nav item-->
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-1.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-3.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-8.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-26.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-21.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-34.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ asset('assets/frontend/assets/media/stock/600x400/img-27.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<img alt="Logo" src="{{ asset('assets/frontend/assets/media/svg/brand-logos/google-icon.svg') }}" class="h-20px me-3" />Invite Gmail Contacts</div>
							...
							<div class="mh-300px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-6.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-1.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-5.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-25.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-9.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-23.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-12.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-13.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ asset('assets/frontend/assets/media/avatars/300-21.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
