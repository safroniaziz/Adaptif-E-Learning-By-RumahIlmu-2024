...
<base href="../" />
	...
	<body id="kt_app_body" data-kt-app-header-stacked="true" data-kt-app-header-primary-enabled="true" data-kt-app-header-secondary-enabled="true" data-kt-app-toolbar-enabled="true" class="app-default">
        ...
        @php
            $jumlahKelas = KelasMahasiswa::where('mahasiswa_id',Auth::user()->id)->count();
        $jumlahDiskusi = Diskusi::where('mahasiswa_id',Auth::user()->id)->count();
        $jumlahRespon = DiskusiRespon::where('mahasiswa_id',Auth::user()->id)->count();
        @endphp
