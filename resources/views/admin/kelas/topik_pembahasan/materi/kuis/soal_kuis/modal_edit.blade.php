<div class="modal fade" id="modalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('kelas.topikPembahasan.materi.kuis.update',[$data->materi->topikPembahasanKelas->kelas->id, $data->materi->topikPembahasanKelas->id, $data->id]) }}" method="POST" class="form">
