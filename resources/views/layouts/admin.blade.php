...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/application/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/application/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}">
        ...
        <style>
            .button-container {
                ...
                justify-content: flex-end; /* Mengatur agar isi container tersusun di ujung kanan */
            }

            .button-container form,
            .button-container a {
                margin-left: 1px; /* Memberi jarak antara setiap tombol */
            }
            ...
            .button-container2form {
                flex: 11calc(50% - 10px); /* Dua tombol per baris dengan jarak 10px */box-sizing: border-box; /* Menghitung padding dan border dalam lebar elemen */margin: 0;
            }
            ...
            .btn-delete {
                padding: 2px 6px;
                margin-left: 10px;
                width: auto; /* Tombol hapus tidak mengambil lebar penuh */
            }

            .text-center .btn-add {
                display: block;
                width: 100%; /* Tombol Add mengambil lebar penuh */
                padding: 5px 10px;
                margin-top: 10px;
            }
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <aside class="main-sidebar">
                ...
                <div class="user-panel" style="padding: 14px 10px !important;">
                    <div class="pull-left image">
                      <img src="{{ asset('assets/img/logo-bg.jpg') }}" style="height: 120px !important; width:100% !important; max-width:100% !important " alt="User Image">
                    </div>
                    <div class="pull-left info" style="padding: 7px 5px 5px 15px;">
                      <p>Welcome,</p>
                      <a href="#" style="text-transform: capitalize; font-size:13px !important;"><i class="fa fa-user"></i> {{ auth()->user()->nama_lengkap }}</a>
                    </div>
                </div>
        ...
        <script src="{{ asset('assets/application/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
