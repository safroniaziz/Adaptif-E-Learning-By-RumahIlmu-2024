...
<li class="treeview {{ set_active(['rubrikPenilaian','indikatorPenilaian','penilaianKelompok','soalKuis','soalKuis.detail']) }}">
    <a href="#">
    ...
    <ul class="treeview-menu " style="padding-left:25px;">
        <li class="{{ set_active(['soalKuis','soalKuis.detail']) }}"><a href="{{ route('soalKuis') }}"><i class="fa fa-circle-o"></i>&nbsp;Soal Kuis</a></li>
